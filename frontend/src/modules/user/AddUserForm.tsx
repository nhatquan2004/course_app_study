			...
			<form className="space-y-6 p-6">
				<div className="grid gap-6 md:grid-cols-2">
					...
					<div className="md:col-span-2">
						...
						<input
							...
							className="w-full rounded-lg border border-slate-300 px-4 py-2.5 text-sm outline-none transition focus:border-blue-500 focus:ring-4 focus:ring-blue-100"
						/>
					</div>
					...
					<div className="md:col-span-2">
						...
						<select
							name="role"
							className="w-full rounded-lg border border-slate-300 bg-white px-4 py-2.5 text-sm outline-none transition focus:border-blue-500 focus:ring-4 focus:ring-blue-100">
				...
				<div className="flex justify-end gap-3 border-t border-slate-100 pt-6">
					<button
						...
						className="rounded-lg border border-slate-300 px-5 py-2.5 text-sm font-semibold text-slate-700 transition hover:bg-slate-50 active:scale-95">
						Hủy
					</button>
