		...
		<div className="w-full max-w-3xl bg-white rounded-xl border border-slate-200 p-6 shadow-sm">
			...
			<ul className="divide-y divide-slate-100">
				{categoryList?.map(cat => (
					<li key={cat._id} className="py-3.5 flex justify-between items-center text-slate-700 hover:bg-slate-50/30 px-3 rounded-lg transition duration-150">
				...
				{categoryList.length === 0 && (
					<li className="py-4 text-center text-sm text-slate-400 italic">Chưa có danh mục nào trên hệ thống.</li>
				)}
			</ul>
